...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="relative flex justify-between items-center px-12 py-4 max-w-7xl mx-auto bg-transparent bg-opacity-50">
      <div className="relative text-yellow-500 text-3xl font-bold">K</div>
      <div className="relative flex-1 justify-start">
        <ul className="inline-flex sm:flex-row justify-center flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center  w-[90%] sm:w-[400px] max-w-[400px] lg:gap-6 bg-gray-100 bg-opacity-75 px-6 py-0.5 rounded-lg">
          <li
