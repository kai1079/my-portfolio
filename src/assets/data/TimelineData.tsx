...
export const timelineData: TimelineItemData[] = [
  {
    ...
    skills: ["C#", ".NET", ".NET Core", "React", "TypeScript", "AWS", "Buildkite", "Kubernetes", "Docker", "CloudFront"]
  },
  {
    ...
    skills: ["Java", "Spring Boot", "Kafka", "Redis", "RabbitMQ", "MySQL", "JWT", "OAuth"]
  },
  {
    company: "DEK - ENDAVA",
    title: "SOFTWARE ENGINEERING CONSULTANT",
  ...
  Gerrit for code review and version control.",
    ...
    skills: ["C/C++", "Python", "Java", "Bash Script",
      "OpenSAF", "Autotools", "Makefile", "TestNG",
      "Jira", "Jenkins", "Git", "Gerrit"]
  }
];